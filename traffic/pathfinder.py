...
class Pathfinder:
    ...
    def find_path(
        ...
        Args:
            ...
            blocked_cells: Optional - Set von (x, y) Positionen, die dauerhaft gemieden werden
        ...
        # Blocked cells als Set initialisieren
        blocked = set(blocked_cells) if blocked_cells else set()
        ...
        while open_set and iterations < max_iterations:
            ...
            # Nachbarn expandieren - NEU: blocked_cells übergeben
            neighbors = self._get_neighbors(x, y, t, robot_id, allow_waiting, blocked)
    ...
    def _get_neighbors(self, x, y, t, robot_id, allow_waiting, blocked_cells=None):
        """
        Gibt mögliche nächste Positionen mit Kosten zurück.

        NEU: Berücksichtigt Highway-Penalties und blocked_cells.
        ...
        for dx, dy in directions:
            ...
            # NEU: Blockierte Zellen überspringen
            if (nx, ny) in blocked:
                continue
